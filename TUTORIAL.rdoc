...
To find out what relationships exist for a given class, you can use the has_what and belongs_to_what class methods:

  puts Gene.has_what.join(';')
  puts Gene.belongs_to_what.join(';')
